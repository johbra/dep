...
var G__19267 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__19267,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__19267;
}
});
...
var len__4531__auto___19272 = arguments.length;
var i__4532__auto___19273 = (0);
while(true){
if((i__4532__auto___19273 < len__4531__auto___19272)){
args__4534__auto__.push((arguments[i__4532__auto___19273]));

var G__19274 = (i__4532__auto___19273 + (1));
i__4532__auto___19273 = G__19274;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq19269){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19270,G__19271,seq19269__$2);
});
...
var file = cljs.core.get.call(null,map__19276__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__19276__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__19276__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__19276,map__19276__$1,file,line,column){
return (function (p1__19275_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__19275_SHARP_));
});})(map__19276,map__19276__$1,file,line,column))
...
var temp__5457__auto___19278 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___19278)){
var message_19279 = temp__5457__auto___19278;
cljs.core.println.call(null,message_19279);
} else {
}
...
var temp__5457__auto___19280 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___19280)){
var message_19281 = temp__5457__auto___19280;
cljs.core.println.call(null,message_19281);
} else {
}
...
var output_dir__$1 = (function (){var G__19282 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__19282),"/"].join('');
} else {
return G__19282;
}
})();
...
var G__19284 = exception.stack;
var G__19284__$1 = (((G__19284 == null))?null:clojure.string.split_lines.call(null,G__19284));
var G__19284__$2 = (((G__19284__$1 == null))?null:cljs.core.get.call(null,G__19284__$1,depth));
if((G__19284__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__19284__$2);
}
} else {
...
var vec__19285 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__19285,(0),null);
var column = cljs.core.nth.call(null,vec__19285,(1),null);
var vec__19288 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__19288,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__19288,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__19288,(2),null);
...
var m__$1 = (function (){var G__19291 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__19295 = (function (){var G__19294 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__19294);
} else {
return G__19294;
}
})();
...
return cljs.core.vary_meta.call(null,G__19296,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__19300 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__19300,(0),null);
var types = vec__19300;
...
return cljs.core.map.call(null,(function (p__19303){
var vec__19304 = p__19303;
var ns = cljs.core.nth.call(null,vec__19304,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__19304,(1),null);
return ((function (vec__19304,ns,vars__$1){
return (function (){
...
var G__19307 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__19307__$1 = (((G__19307 instanceof cljs.core.Keyword))?G__19307.fqn:null);
switch (G__19307__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__19307,G__19307__$1,env,once_fixtures,each_fixtures,vec__19304,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__19307,G__19307__$1,env,once_fixtures,each_fixtures,vec__19304,ns,vars__$1){
return (function (){
var seq__19308 = cljs.core.seq.call(null,vars__$1);
var chunk__19309 = null;
var count__19310 = (0);
var i__19311 = (0);
while(true){
if((i__19311 < count__19310)){
var v = cljs.core._nth.call(null,chunk__19309,i__19311);
var temp__5457__auto___19313 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___19313)){
var t_19314 = temp__5457__auto___19313;
each_fixture_fn.call(null,((function (seq__19308,chunk__19309,count__19310,i__19311,t_19314,temp__5457__auto___19313,v,each_fixture_fn,G__19307,G__19307__$1,env,once_fixtures,each_fixtures,vec__19304,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_19314)));
});})(seq__19308,chunk__19309,count__19310,i__19311,t_19314,temp__5457__auto___19313,v,each_fixture_fn,G__19307,G__19307__$1,env,once_fixtures,each_fixtures,vec__19304,ns,vars__$1))
);
} else {
}


var G__19315 = seq__19308;
var G__19316 = chunk__19309;
var G__19317 = count__19310;
var G__19318 = (i__19311 + (1));
seq__19308 = G__19315;
chunk__19309 = G__19316;
count__19310 = G__19317;
i__19311 = G__19318;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__19308);
if(temp__5457__auto__){
var seq__19308__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__19308__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__19308__$1);
var G__19319 = cljs.core.chunk_rest.call(null,seq__19308__$1);
var G__19320 = c__4351__auto__;
var G__19321 = cljs.core.count.call(null,c__4351__auto__);
var G__19322 = (0);
seq__19308 = G__19319;
chunk__19309 = G__19320;
count__19310 = G__19321;
i__19311 = G__19322;
continue;
} else {
var v = cljs.core.first.call(null,seq__19308__$1);
var temp__5457__auto___19323__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___19323__$1)){
var t_19324 = temp__5457__auto___19323__$1;
each_fixture_fn.call(null,((function (seq__19308,chunk__19309,count__19310,i__19311,t_19324,temp__5457__auto___19323__$1,v,seq__19308__$1,temp__5457__auto__,each_fixture_fn,G__19307,G__19307__$1,env,once_fixtures,each_fixtures,vec__19304,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_19324)));
});})(seq__19308,chunk__19309,count__19310,i__19311,t_19324,temp__5457__auto___19323__$1,v,seq__19308__$1,temp__5457__auto__,each_fixture_fn,G__19307,G__19307__$1,env,once_fixtures,each_fixtures,vec__19304,ns,vars__$1))
);
} else {
}
...
});})(each_fixture_fn,G__19307,G__19307__$1,env,once_fixtures,each_fixtures,vec__19304,ns,vars__$1))
);
});})(each_fixture_fn,G__19307,G__19307__$1,env,once_fixtures,each_fixtures,vec__19304,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__19307__$1)].join('')));

}
})());
});
;})(vec__19304,ns,vars__$1))
