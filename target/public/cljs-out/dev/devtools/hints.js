...
}catch (e22069){var _e = e22069;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___22072 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___22072)){
var seen_errors_22073 = temp__5455__auto___22072;
if(cljs.core.truth_(seen_errors_22073.has(self))){
} else {
seen_errors_22073.add(self);

var temp__5457__auto___22074 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___22074)){
var sense_22075 = temp__5457__auto___22074;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_22075)].join('');
} else {
}
}
} else {
