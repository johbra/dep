...
var len__4531__auto___21232 = arguments.length;
var i__4532__auto___21233 = (0);
while(true){
if((i__4532__auto___21233 < len__4531__auto___21232)){
args__4534__auto__.push((arguments[i__4532__auto___21233]));

var G__21234 = (i__4532__auto___21233 + (1));
i__4532__auto___21233 = G__21234;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq21229){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21230,G__21231,seq21229__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__21235_SHARP_){
return !((cljs.core.meta.call(null,p1__21235_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__21236__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e21240){var _e__20220__auto__ = e21240;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e21242){var _e__20220__auto__ = e21242;
return false;
}}
})())){
...
var _STAR_current_state_STAR_21244 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__21245 = opts;
...
var markup_db = cljs.core.get.call(null,map__21245__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_21244;
}});
...
;
var temp__5455__auto___21249 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___21249)){
var managed_print_level_21250 = temp__5455__auto___21249;
var _STAR_print_level_STAR_21248_21251 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_21250;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_21248_21251,managed_print_level_21250,temp__5455__auto___21249,writer,opts,job_fn){
return (function (p1__21247_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__21247_SHARP_,null);
});})(_STAR_print_level_STAR_21248_21251,managed_print_level_21250,temp__5455__auto___21249,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_21248_21251;
}} else {
job_fn.call(null);
}
