...
var G__21203 = devtools.prefs.pref.call(null,v);
v = G__21203;
continue;
} else {
return v;
...
}catch (e21206){var _e__20220__auto__ = e21206;
return false;
}})();
...
}catch (e21210){var _e__20220__auto__ = e21210;
return false;
}})();
...
}catch (e21212){var _e__20220__auto__ = e21212;
return false;
}}
}
});
...
var vec__21214 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__21214,(0),null);
var name = cljs.core.nth.call(null,vec__21214,(1),null);
...
return cljs.core.some.call(null,(function (p1__21217_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__21217_SHARP_);
}),template);
});
