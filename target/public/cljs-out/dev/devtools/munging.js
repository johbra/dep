...
var o21101 = temp__5455__auto__;
var temp__5455__auto____$1 = (o21101["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o21102 = temp__5455__auto____$1;
return (o21102["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__20213__auto__ = f;
return (o__20213__auto__["toString"]).call(o__20213__auto__);
} else {
return "";
}
}catch (e21103){var _ = e21103;
return "";
}});
...
try{var o__20213__auto___21105 = t;
(o__20213__auto___21105["cljs$lang$ctorPrWriter"]).call(o__20213__auto___21105,t,writer);
}catch (e21104){var __21106 = e21104;
}
...
var char_code = (function (){var o__20213__auto__ = (new String(char$));
return (o__20213__auto__["charCodeAt"]).call(o__20213__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__20213__auto__ = String;
return (o__20213__auto__["fromCharCode"]).call(o__20213__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__21107 = num_code;
switch (G__21107) {
case (1):
return (185);
...
var o__20213__auto__ = String;
return (o__20213__auto__["fromCharCode"]).call(o__20213__auto__,superscript_code);
});
/**
...
}catch (e21109){var _e__20220__auto__ = e21109;
return false;
}})())){
...
var vec__21110 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__21110,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o21113 = temp__5455__auto__;
var temp__5455__auto____$1 = (o21113["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o21114 = temp__5455__auto____$1;
return (o21114["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__21117){
var vec__21118 = p__21117;
var ns_detector = cljs.core.nth.call(null,vec__21118,(0),null);
...
var G__21124 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__21125 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__21124;
remaining_tokens = G__21125;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq21115){
var G__21116 = cljs.core.first.call(null,seq21115);
var seq21115__$1 = cljs.core.next.call(null,seq21115);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21116,seq21115__$1);
});
...
var vec__21129 = cljs.core.split_with.call(null,(function (p1__21128_SHARP_){
return cljs.core.not_EQ_.call(null,p1__21128_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__21129,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__21129,(1),null);
...
var vec__21132 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__21132,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__21132,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__21135 = cljs.core.rest.call(null,remaining_tokens);
var G__21136 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__21135;
name_tokens = G__21136;
continue;
} else {
...
var vec__21139 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__21139,(0),null);
var arity = cljs.core.nth.call(null,vec__21139,(1),null);
var vec__21142 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__21142,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__21142,(1),null);
var vec__21145 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__21145,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__21145,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__21145,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__21145,(3),null);
...
var vec__21151 = result;
var munged_ns = cljs.core.nth.call(null,vec__21151,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__21151,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__21151,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__21151,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__21151,(4),null);
var arity = cljs.core.nth.call(null,vec__21151,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__21155 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__21155,(0),null);
var args = cljs.core.nth.call(null,vec__21155,(1),null);
var vec__21158 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__21158,(0),null);
var name = cljs.core.nth.call(null,vec__21158,(1),null);
...
var G__21161 = (arity + (1));
var G__21162 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__21163){
var vec__21164 = p__21163;
var arity = cljs.core.nth.call(null,vec__21164,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__21164,(1),null);
...
return cljs.core.get.call(null,arities,p1__21167_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__21168_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__21171){
var vec__21172 = p__21171;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__21172,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq21169){
var G__21170 = cljs.core.first.call(null,seq21169);
var seq21169__$1 = cljs.core.next.call(null,seq21169);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21170,seq21169__$1);
});
...
var map__21180 = options;
var map__21180__$1 = ((((!((map__21180 == null)))?(((((map__21180.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21180.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21180):map__21180);
var include_ns_QMARK_ = cljs.core.get.call(null,map__21180__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__21180__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__21180__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__21180__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__21181 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__21181,(0),null);
var fn_name = cljs.core.nth.call(null,vec__21181,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__21181,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__21181,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__21181,(4),null);
var arity = cljs.core.nth.call(null,vec__21181,(5),null);
...
var o__20213__auto__ = f;
return (o__20213__auto__["getBasis"]).call(o__20213__auto__);
});
/**
...
}catch (e21185){var _e__20220__auto__ = e21185;
...
var G__21186 = (obj[cljs.core.first.call(null,path)]);
var G__21187 = cljs.core.rest.call(null,path);
obj = G__21186;
path = G__21187;
continue;
} else {
...
return (function (accum,p__21188){
var vec__21189 = p__21188;
var bit = cljs.core.nth.call(null,vec__21189,(0),null);
var protocol = cljs.core.nth.call(null,vec__21189,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__21192){
var vec__21193 = p__21192;
var ns = cljs.core.nth.call(null,vec__21193,(0),null);
var name = cljs.core.nth.call(null,vec__21193,(1),null);
var selector = cljs.core.nth.call(null,vec__21193,(2),null);
...
return (function (p__21197){
var vec__21198 = p__21197;
var munged_name = cljs.core.nth.call(null,vec__21198,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__21198,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__21198,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__21196_SHARP_){
return (obj[cljs.core.first.call(null,p1__21196_SHARP_)]);
});})(name,sorted_matches,vec__21198,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
