...
+ Eigenschaften:
  ...
  + Ein Minibeispiel für eine Dozenten-Pflege existiert: [[file:~/Dropbox/elm/dep/src/Dozent-V0.elm][Quelltext]]
    #+BEGIN_SRC sh
...
+ Model: 5 cljc-Dateien mit 71 Definitionen; ca. 550 LoC
+ Weboberfläche (cljs-Dateien):
  ...
  + 12 Hilfsfunktionen 18 ; ca. 230 LoC
*** Web-Technologie
...
+ der ClojureScript-Variante noch ein paar Kleinigkeiten fehlen (Der
  ...
  + ein paar Sicherheitsabfragen z.\nbsp{}B. beim Löschen von Moduln
    oder Manipeln oder der Neuplanung eines Quartal sowie
...
+ Gerade bei der objektorienten Programmierung von Oberflächen hat man
