...
var o16428 = temp__5455__auto__;
var temp__5455__auto____$1 = (o16428["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o16429 = temp__5455__auto____$1;
return (o16429["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__15540__auto__ = f;
return (o__15540__auto__["toString"]).call(o__15540__auto__);
} else {
return "";
}
...
try{var o__15540__auto___16432 = t;
(o__15540__auto___16432["cljs$lang$ctorPrWriter"]).call(o__15540__auto___16432,t,writer);
}catch (e16431){var __16433 = e16431;
}
...
var char_code = (function (){var o__15540__auto__ = (new String(char$));
return (o__15540__auto__["charCodeAt"]).call(o__15540__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__15540__auto__ = String;
return (o__15540__auto__["fromCharCode"]).call(o__15540__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__16434 = num_code;
switch (G__16434) {
case (1):
return (185);
...
var o__15540__auto__ = String;
return (o__15540__auto__["fromCharCode"]).call(o__15540__auto__,superscript_code);
});
/**
...
}catch (e16436){var _e__15547__auto__ = e16436;
return false;
}})())){
...
var vec__16437 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__16437,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o16440 = temp__5455__auto__;
var temp__5455__auto____$1 = (o16440["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o16441 = temp__5455__auto____$1;
return (o16441["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___16448 = arguments.length;
var i__4532__auto___16449 = (0);
while(true){
if((i__4532__auto___16449 < len__4531__auto___16448)){
args__4534__auto__.push((arguments[i__4532__auto___16449]));

var G__16450 = (i__4532__auto___16449 + (1));
i__4532__auto___16449 = G__16450;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__16444){
var vec__16445 = p__16444;
var ns_detector = cljs.core.nth.call(null,vec__16445,(0),null);
...
var G__16451 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__16452 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__16451;
remaining_tokens = G__16452;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq16442){
var G__16443 = cljs.core.first.call(null,seq16442);
var seq16442__$1 = cljs.core.next.call(null,seq16442);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16443,seq16442__$1);
});
...
var vec__16456 = cljs.core.split_with.call(null,(function (p1__16455_SHARP_){
return cljs.core.not_EQ_.call(null,p1__16455_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__16456,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__16456,(1),null);
...
var vec__16459 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__16459,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__16459,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__16462 = cljs.core.rest.call(null,remaining_tokens);
var G__16463 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__16462;
name_tokens = G__16463;
continue;
} else {
...
var vec__16466 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__16466,(0),null);
var arity = cljs.core.nth.call(null,vec__16466,(1),null);
var vec__16469 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__16469,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__16469,(1),null);
var vec__16472 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__16472,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__16472,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__16472,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__16472,(3),null);
...
var vec__16478 = result;
var munged_ns = cljs.core.nth.call(null,vec__16478,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__16478,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__16478,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__16478,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__16478,(4),null);
var arity = cljs.core.nth.call(null,vec__16478,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__16482 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__16482,(0),null);
var args = cljs.core.nth.call(null,vec__16482,(1),null);
var vec__16485 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__16485,(0),null);
var name = cljs.core.nth.call(null,vec__16485,(1),null);
...
var G__16488 = (arity + (1));
var G__16489 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__16490){
var vec__16491 = p__16490;
var arity = cljs.core.nth.call(null,vec__16491,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__16491,(1),null);
...
return cljs.core.get.call(null,arities,p1__16494_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__16495_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__16498){
var vec__16499 = p__16498;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__16499,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq16496){
var G__16497 = cljs.core.first.call(null,seq16496);
var seq16496__$1 = cljs.core.next.call(null,seq16496);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16497,seq16496__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__16507__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__16507__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__16507__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__16507__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__16508 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__16508,(0),null);
var fn_name = cljs.core.nth.call(null,vec__16508,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__16508,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__16508,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__16508,(4),null);
var arity = cljs.core.nth.call(null,vec__16508,(5),null);
...
var o__15540__auto__ = f;
return (o__15540__auto__["getBasis"]).call(o__15540__auto__);
});
/**
...
}catch (e16512){var _e__15547__auto__ = e16512;
...
var G__16513 = (obj[cljs.core.first.call(null,path)]);
var G__16514 = cljs.core.rest.call(null,path);
obj = G__16513;
path = G__16514;
continue;
} else {
...
return (function (accum,p__16515){
var vec__16516 = p__16515;
var bit = cljs.core.nth.call(null,vec__16516,(0),null);
var protocol = cljs.core.nth.call(null,vec__16516,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__16519){
var vec__16520 = p__16519;
var ns = cljs.core.nth.call(null,vec__16520,(0),null);
var name = cljs.core.nth.call(null,vec__16520,(1),null);
var selector = cljs.core.nth.call(null,vec__16520,(2),null);
...
return (function (p__16524){
var vec__16525 = p__16524;
var munged_name = cljs.core.nth.call(null,vec__16525,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__16525,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__16525,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__16523_SHARP_){
return (obj[cljs.core.first.call(null,p1__16523_SHARP_)]);
});})(name,sorted_matches,vec__16525,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
