...
var o21637 = temp__5455__auto__;
var temp__5455__auto____$1 = (o21637["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o21638 = temp__5455__auto____$1;
return (o21638["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__20749__auto__ = f;
return (o__20749__auto__["toString"]).call(o__20749__auto__);
} else {
return "";
}
}catch (e21639){var _ = e21639;
return "";
}});
...
try{var o__20749__auto___21641 = t;
(o__20749__auto___21641["cljs$lang$ctorPrWriter"]).call(o__20749__auto___21641,t,writer);
}catch (e21640){var __21642 = e21640;
}
...
var char_code = (function (){var o__20749__auto__ = (new String(char$));
return (o__20749__auto__["charCodeAt"]).call(o__20749__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__20749__auto__ = String;
return (o__20749__auto__["fromCharCode"]).call(o__20749__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__21643 = num_code;
switch (G__21643) {
case (1):
return (185);
...
var o__20749__auto__ = String;
return (o__20749__auto__["fromCharCode"]).call(o__20749__auto__,superscript_code);
});
/**
...
}catch (e21645){var _e__20756__auto__ = e21645;
return false;
}})())){
...
var vec__21646 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__21646,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o21649 = temp__5455__auto__;
var temp__5455__auto____$1 = (o21649["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o21650 = temp__5455__auto____$1;
return (o21650["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___21657 = arguments.length;
var i__4532__auto___21658 = (0);
while(true){
if((i__4532__auto___21658 < len__4531__auto___21657)){
args__4534__auto__.push((arguments[i__4532__auto___21658]));

var G__21659 = (i__4532__auto___21658 + (1));
i__4532__auto___21658 = G__21659;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__21653){
var vec__21654 = p__21653;
var ns_detector = cljs.core.nth.call(null,vec__21654,(0),null);
...
var G__21660 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__21661 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__21660;
remaining_tokens = G__21661;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq21651){
var G__21652 = cljs.core.first.call(null,seq21651);
var seq21651__$1 = cljs.core.next.call(null,seq21651);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21652,seq21651__$1);
});
...
var vec__21665 = cljs.core.split_with.call(null,(function (p1__21664_SHARP_){
return cljs.core.not_EQ_.call(null,p1__21664_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__21665,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__21665,(1),null);
...
var vec__21668 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__21668,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__21668,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__21671 = cljs.core.rest.call(null,remaining_tokens);
var G__21672 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__21671;
name_tokens = G__21672;
continue;
} else {
...
var vec__21675 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__21675,(0),null);
var arity = cljs.core.nth.call(null,vec__21675,(1),null);
var vec__21678 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__21678,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__21678,(1),null);
var vec__21681 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__21681,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__21681,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__21681,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__21681,(3),null);
...
var vec__21687 = result;
var munged_ns = cljs.core.nth.call(null,vec__21687,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__21687,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__21687,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__21687,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__21687,(4),null);
var arity = cljs.core.nth.call(null,vec__21687,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__21691 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__21691,(0),null);
var args = cljs.core.nth.call(null,vec__21691,(1),null);
var vec__21694 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__21694,(0),null);
var name = cljs.core.nth.call(null,vec__21694,(1),null);
...
var G__21697 = (arity + (1));
var G__21698 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__21699){
var vec__21700 = p__21699;
var arity = cljs.core.nth.call(null,vec__21700,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__21700,(1),null);
...
return cljs.core.get.call(null,arities,p1__21703_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__21704_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___21711 = arguments.length;
var i__4532__auto___21712 = (0);
while(true){
if((i__4532__auto___21712 < len__4531__auto___21711)){
args__4534__auto__.push((arguments[i__4532__auto___21712]));

var G__21713 = (i__4532__auto___21712 + (1));
i__4532__auto___21712 = G__21713;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__21707){
var vec__21708 = p__21707;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__21708,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq21705){
var G__21706 = cljs.core.first.call(null,seq21705);
var seq21705__$1 = cljs.core.next.call(null,seq21705);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21706,seq21705__$1);
});
...
var map__21716 = options;
var map__21716__$1 = ((((!((map__21716 == null)))?(((((map__21716.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21716.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21716):map__21716);
var include_ns_QMARK_ = cljs.core.get.call(null,map__21716__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__21716__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__21716__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__21716__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__21717 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__21717,(0),null);
var fn_name = cljs.core.nth.call(null,vec__21717,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__21717,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__21717,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__21717,(4),null);
var arity = cljs.core.nth.call(null,vec__21717,(5),null);
...
var o__20749__auto__ = f;
return (o__20749__auto__["getBasis"]).call(o__20749__auto__);
});
/**
...
}catch (e21721){var _e__20756__auto__ = e21721;
...
var G__21722 = (obj[cljs.core.first.call(null,path)]);
var G__21723 = cljs.core.rest.call(null,path);
obj = G__21722;
path = G__21723;
continue;
} else {
...
return (function (accum,p__21724){
var vec__21725 = p__21724;
var bit = cljs.core.nth.call(null,vec__21725,(0),null);
var protocol = cljs.core.nth.call(null,vec__21725,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__21728){
var vec__21729 = p__21728;
var ns = cljs.core.nth.call(null,vec__21729,(0),null);
var name = cljs.core.nth.call(null,vec__21729,(1),null);
var selector = cljs.core.nth.call(null,vec__21729,(2),null);
...
return (function (p__21733){
var vec__21734 = p__21733;
var munged_name = cljs.core.nth.call(null,vec__21734,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__21734,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__21734,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__21732_SHARP_){
return (obj[cljs.core.first.call(null,p1__21732_SHARP_)]);
});})(name,sorted_matches,vec__21734,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
