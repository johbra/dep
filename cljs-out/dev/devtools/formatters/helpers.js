...
var G__16530 = devtools.prefs.pref.call(null,v);
v = G__16530;
continue;
} else {
return v;
...
}catch (e16533){var _e__15547__auto__ = e16533;
return false;
}})();
...
}catch (e16537){var _e__15547__auto__ = e16537;
return false;
}})();
...
}catch (e16539){var _e__15547__auto__ = e16539;
return false;
}}
}
});
...
var vec__16541 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__16541,(0),null);
var name = cljs.core.nth.call(null,vec__16541,(1),null);
...
return cljs.core.some.call(null,(function (p1__16544_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__16544_SHARP_);
}),template);
});
