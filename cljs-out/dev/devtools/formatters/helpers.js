...
var G__21739 = devtools.prefs.pref.call(null,v);
v = G__21739;
continue;
} else {
return v;
...
}catch (e21742){var _e__20756__auto__ = e21742;
return false;
}})();
...
}catch (e21746){var _e__20756__auto__ = e21746;
return false;
}})();
...
}catch (e21748){var _e__20756__auto__ = e21748;
return false;
}}
}
});
...
var vec__21750 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__21750,(0),null);
var name = cljs.core.nth.call(null,vec__21750,(1),null);
...
return cljs.core.some.call(null,(function (p1__21753_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__21753_SHARP_);
}),template);
});
