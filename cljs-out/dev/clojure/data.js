...
return cljs.core.reduce.call(null,(function (result,p__16598){
...
var vec__16602 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__16602,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__16602,(1),null);
var ab = cljs.core.nth.call(null,vec__16602,(2),null);
...
return (function (){var G__16611 = clojure.data.equality_partition.call(null,a);
var G__16611__$1 = (((G__16611 instanceof cljs.core.Keyword))?G__16611.fqn:null);
switch (G__16611__$1) {
case "atom":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__16611__$1)].join('')));
